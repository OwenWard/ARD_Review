...
## log gregariousness of individuals
beta <- rnorm(K, mu_beta, sigma_beta)
## log prevalence of subgroups
...
library(rstan)
fit <- stan(
  model_code = stan_model, # file='NB_norecall.stan',
  data = data,
...
plot(alpha, alpha_hat,
  main = "Individuals' Gregariousness",
